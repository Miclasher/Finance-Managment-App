    ...
    public partial class MonobankImportSecond : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MccTransactionType", x => new { x.MccId, x.TransactionTypesId });
                    table.ForeignKey(
                        name: "FK_MccTransactionType_Mcc_MccId",
                        column: x => x.MccId,
                        principalTable: "Mcc",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MccTransactionTypeTemplate", x => new { x.MccId, x.TransactionTypeTemplatesId });
                    table.ForeignKey(
                        name: "FK_MccTransactionTypeTemplate_Mcc_MccId",
                        column: x => x.MccId,
                        principalTable: "Mcc",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
...
INSERT INTO MccTransactionTypeTemplate (MccId, TransactionTypeTemplatesId)
...
";
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                DELETE FROM MccTransactionTypeTemplate WHERE MccId IN (SELECT Id FROM Mcc WHERE Value >= -2 AND Value <= 9950);
